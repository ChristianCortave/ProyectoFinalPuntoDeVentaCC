                                    ...
                                    <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="txtfecha_edit"
                                                        name="txtfecha_edit" placeholder="fecha edit" required>
                                                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?=base_url("localizar_modificar_unidades/".$dato['id'])?>">
                            ...
                            <div class="modal fade" id="exampleModaldel" tabindex="-1" aria-labelledby="exampleModaldel"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?=base_url("eliminar_unidades/".$dato['id'])?>" method='get'>
