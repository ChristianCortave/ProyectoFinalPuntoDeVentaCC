...
<body>
    <div class="container">
        <div class="row">
           <center><h1>Modificar Unidades</h1></center> 
            <div class="col-md-8 border border-danger">
            <center>
                <form action="<?=base_url('modificar_unidades')?>" method='post'>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="txtnombre_corto" name="txtnombre_corto"
                            placeholder="nombre corto" value="<?=$data['nombre_corto'] ?>">
                    </div>
