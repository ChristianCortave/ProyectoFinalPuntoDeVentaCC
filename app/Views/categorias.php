                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="<?=base_url('guardar_categorias')?>" method='post'>
                                    ...
                                    <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="txxtactivo"
                                                        name="txxtactivo" placeholder="activo" required>
                                                </div>

                                                <div class="mb-3">
                                                    <label for="txtfecha_alta" class="form-label">Fecha de
                                                        alta</label>
                                                    <input type="date" class="form-control" id="txtfecha_alta"
                                                        name="txtfecha_alta" placeholder="fecha alta" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="txtfecha_edit" class="form-label">Fecha
                                                        edit</label>
                                                    <input type="date" class="form-control" id="txtfecha_edit"
                                                        name="txtfecha_edit" placeholder="fecha edit" >
                                                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?=base_url("localizar_modificar_categorias/".$dato['id'])?>">
                            ...
                            <div class="modal fade" id="exampleModaldel" tabindex="-1" aria-labelledby="exampleModaldel"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?=base_url("eliminar_categorias/".$dato['id'])?>" method='get'>
