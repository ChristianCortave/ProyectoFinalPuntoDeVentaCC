...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav_content">
        <main class="container-fluid px-5 pt-5 row">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="<?=base_url('guardar_clientes')?>" method='post'>
                                    ...
                                    <div class="mb-3">
                                        <label for="txtalta" class="form-label">Fecha de
                                            alta</label>
                                        <input type="date" class="form-control" id="txtalta" name="txtalta"
                                            placeholder="alta" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="txtedit" class="form-label">Fecha
                                            edit</label>
                                        <input type="date" class="form-control" id="txtedit" name="txtedit"
                                            placeholder="edit">
                                    </div>
                ...
                <div class="table-responsive">
                    ...
                    <div class="card-body">
                        <table id="datatablesSimple">
                            ...
                            <tbody>
                                <?php foreach($resultadoclientes as $dato){ ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?=base_url("localizar_modificar_clientes/".$dato['id'])?>">
