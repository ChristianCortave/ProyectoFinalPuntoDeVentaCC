                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="<?=base_url('guardar_usuarios')?>" method='post'>
                                    ...
                                    <div class="mb-3">
                                        <label for="txtid_caja" class="form-label">Id de la Caja</label>
                                        <input type="text" class="form-control" id="txtid_caja"
                                            name="txtid_caja" placeholder="idcaja" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="txtid_rol" class="form-label">Id de la Caja</label>
                                        <input type="text" class="form-control" id="txtid_rol"
                                            name="txtid_rol" placeholder="idrol" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="txtfecha_modifica" class="form-label">Correo
                                            edit</label>
            ...
            <div class="table-responsive">
                ...
                <div class="card-body">
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <?php foreach($resultadousuarios as $dato){ ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?=base_url("localizar_modificar_usuarios/".$dato['id'])?>">
                    ...
                    <div class="modal fade" id="exampleModaldel" tabindex="-1" aria-labelledby="exampleModaldel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?=base_url("eliminar_usuarios/".$dato['id'])?>" method='get'>
