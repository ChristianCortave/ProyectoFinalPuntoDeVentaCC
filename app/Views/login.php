...
<head>
    ...
    <title>Inicio de Sesión - Punto de Venta C.C.</title>
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo base_url('login'); ?>">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <a class="small" type="submit">¿Olvidaste la contraseña?</a>
                                            <button class="btn btn-primary" href="index.html">Ingresar</button>
                                        </div>
                                    </form>
                                </div>
